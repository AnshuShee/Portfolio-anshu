...
const Contributors = () => {
    ...
    return (
        <section id="contributors" className="py-24 border-b border-white/10" style={{ backgroundColor: '#000000', color: '#ffffff' }}>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
                    ...
                    <div className="flex flex-col gap-8">
                        ...
                        <motion.div
                            ...
                            viewport={{ once: true, margin: "-100px" }}
                            className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 lg:p-10 flex flex-col justify-center flex-grow transition-all hover:shadow-[0_4px_20px_rgba(255,255,255,0.05)]"
                        >
                            ...
                            <a 
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="inline-flex items-center justify-center gap-2 bg-orange-600 border border-transparent hover:bg-orange-500 text-white font-bold py-3.5 px-8 rounded-full transition-all w-fit shadow-[0_0_15px_rgba(234,88,12,0.4)]"
                            >
                                <Github size={18} />
                                Follow on GitHub
                            </a>
