...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        const templateParams = {
            name: userName, // Added based on your EmailJS template content
            user_name: userName,
            ...
            subject: subject,
            message: message,
            reply_message: 'Thank you for your response! I have received your message and will get back to you soon.',
        };

        // Use emailjs.send to pass explicit parameters and satisfy all template variables
        emailjs.send('service_nt62jpi', 'template_ayouijb', templateParams, 'e35SHOcJ4xG4UMrc3')
            .then((result) => {
                setStatus('success');
                form.current.reset();
