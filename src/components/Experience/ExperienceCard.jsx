...
const ExperienceCard = ({ index, title, type, duration, description, techStack, githubLink, liveLink, leetcodeLink, postmanLink }) => {
    ...
    return (
        ...
        >
            ...
            <div className="flex items-center gap-4 mt-auto">
                ...
                {postmanLink && (
                    <a href={postmanLink} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-[#FF6C37] hover:text-[#FF8A65] transition-colors text-sm font-medium">
                        <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm4 11h-2v2a1 1 0 0 1-2 0v-2H9a1 1 0 0 1 0-2h2V9a1 1 0 0 1 2 0v2h2a1 1 0 0 1 0 2z" />
                        </svg>
                        Postman
                    </a>
                )}
