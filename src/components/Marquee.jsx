            ...
            <div className="flex w-max animate-marquee">
                ...
                {[...Array(20)].map((_, i) => (
                    <div key={i} className="flex shrink-0 items-center">
                        <span className="text-white text-[1.4rem] md:text-3xl font-black uppercase tracking-[0.1em] font-['Anton'] whitespace-nowrap pl-6 md:pl-10 leading-none pb-1 mt-1">
                            FULL STACK DEV AT WORK
                        </span>
                        <Command className="w-6 h-6 md:w-8 md:h-8 mx-8 md:mx-12 text-white/80" />
                    </div>
                ))}
            </div>
        </div>
